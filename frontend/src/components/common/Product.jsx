                ...
                <div className='col-md-7'>
                    ...
                    <div >
                        ...
                        readonly
                            initialValue={rating}
                        />
                        <span className='pt-2 ps-2'>10 Reviews</span>
                    </div>
                    <div className='price h3 py-3'>
                       $20 <span className='text-decoration-line-through '>$10</span>
                    </div>
                    <div>
                        100% Original products<br/> Pay delivery might be available<br/> Easy 15 days returns and exchange
                    </div>
                    <div className='pt-3'>
